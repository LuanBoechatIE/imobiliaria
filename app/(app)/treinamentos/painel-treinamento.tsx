...
/**
 * Corpo da janela de treinamento. Vive separado do botão que a abre
 * porque só é baixado quando alguém realmente vai criar ou editar um
 * treino: quem só consulta a biblioteca (o caso da maioria, e o caso do
 * corretor no celular) nunca paga por este código.
 */
...
export function PainelTreinamento({
  pessoas,
  treinamento,
  aoFechar,
}: {
        ...
        >
          ...
          <form action={acao} className="flex flex-1 flex-col gap-3.5 overflow-y-auto px-5 py-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex max-h-48 flex-col gap-1 overflow-y-auto rounded-md border border-linha-forte bg-fundo-2 p-2.5">
                {pessoas.length === 0 && (
